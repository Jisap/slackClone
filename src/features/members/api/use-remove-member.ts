...
export const useRemoveMember = () => { // Hook para borrar un member de la bd
  ...
  const mutation = useMutation(api.members.remove) // Definición de la mutation de la api de convex para borrarun miembro de la bd

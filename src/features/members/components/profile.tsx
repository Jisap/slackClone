        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex flex-col p-4">
            ...
            {currentMember?.role === "admin" &&                            // Si el miembro actual (logueado y pertenece al workspace) es admin,
              ...
              ) : currentMember?._id === memberId  &&    // Si el miembro actual es el miembro que se pasa por argumentos (se clikea a si mismo)
                    currentMember?.role !== "admin" ? (  // y no es admin -> se muestra el boton de dejar el workspace (solo sucede si eres un miembro invitado)
                      <div className="mt-4">
                        <Button 
                          variant="outline" 
                          className="w-full"

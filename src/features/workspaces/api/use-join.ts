...
type RequestType = { 
  workspaceId: Id<"workspaces">,                            // Tipado de los argumentos de la mutation de convex
  joinCode: string
};       
...
export const useJoin = () => { // Hook para unir un usuario a un workspace con un código de unión
  ...
  const mutation = useMutation(api.workspaces.join) // Definición de la mutation de la api de convex para unir un usuario a un workspace con un código de unión

...
export const useCreateOrGetConversation = () => { // Hook para crear un message
  ...
  const mutation = useMutation(api.conversations.createOrGet) // Definición de la mutation de la api de convex para obtener o crear una conversación

...
export const useCreateMessage = () => { // Hook para crear un message
  ...
  const mutation = useMutation(api.messages.create) // Definición de la mutation de la api de convex para crear un message

...
export const useDeleteChannel = () => { // Hook para actualizar el nombre de un channel
  ...
  const mutation = useMutation(api.channels.remove) // Definición de la mutation de la api de convex para crear un channel
